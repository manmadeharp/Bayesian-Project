...
class PCN(MetropolisHastings):
    ...
    def __init__(
        ...
        proposal = PCNProposal(
            beta=beta,
            kl_expansion=kl_expansion,
            x_grid=x_grid
        )
...
if __name__ == "__main__":
    ...
    plt.scatter(x_grid, target.data, color='black', alpha=0.5, label='Observations at t=0.1')
    ...
    plt.plot(x_grid, np.sin(np.pi * x_grid), 'g--', linewidth=2, label='True Initial Condition')
